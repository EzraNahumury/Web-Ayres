...
const COVERS: Record<string, { cover: string; color: string }> = {
  "adi-vira":      { cover: "/katalogv2/katalog classic Adi Vira/pembuka.jpeg",     color: "#e03030" },
  "cakra-vega":    { cover: "/katalogv2/katalog classic Cakra Vega/pembuka.jpeg",   color: "#e03030" },
  "bima-sena":     { cover: "/katalogv2/katalog pro Bima Sena/pembuka.jpeg",        color: "#a78bfa" },
  "garuda-vastra": { cover: "/katalogv2/katalog pro Garuda Vastra/pembuka.jpeg",    color: "#a78bfa" },
};
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ background: `${info.color}0d` }}
                    />
                    {/* Top accent line */}
                    <div
                      className="absolute top-0 left-0 right-0 h-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                      style={{ background: `linear-gradient(90deg, ${info.color}, #a78bfa)` }}
                    />
                    {/* Package badge */}
                    <div className="absolute top-3 left-3">
                      <span
                        className="text-[8px] font-black uppercase tracking-[0.2em] px-2.5 py-1 rounded-full border"
                        style={{ color: info.color, borderColor: `${info.color}55`, background: `${info.color}15` }}
                      >
                        {item.package}
                      </span>
                    </div>
