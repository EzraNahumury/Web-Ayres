    ...
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center w-full py-20">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4 items-start">
                <p className="text-white text-xs font-bold tracking-[0.2em] uppercase ml-0">{t.home.label}</p>
                <h1 className="text-white font-black flex flex-col" style={{ lineHeight: 1.05, fontSize: 'clamp(2.8rem, 5vw, 4.2rem)' }}>
                  <span>{t.home.hero1}</span>
                  <GradientText
              ...
              <div className="flex items-center gap-3 pt-1">
                ...
                <p className="text-xs text-[#777]">
                  <span className="text-white font-semibold">500+</span> {t.home.socialProof}
                </p>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center justify-center relative h-[520px]">
              ...
              <div className="absolute z-30 flex flex-col items-center gap-0.5"
                ...
                <div className="text-[#666] text-[10px] tracking-widest uppercase font-medium">{t.home.startingFrom}</div>
      ...
      <section id="gallery" className="pt-20 pb-0 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-[1fr_1.2fr] gap-12 items-center mb-10">
            ...
            {/* Kiri */}
            <div>
              <p className="text-[#e03030] text-[10px] font-bold uppercase tracking-[0.35em] mb-6">{t.home.whoWeAre}</p>
              <h2 className="font-black text-white leading-[0.95] tracking-tight mb-8"
                style={{ fontSize: 'clamp(3rem, 6vw, 5.5rem)' }}>
                {t.home.mainH1}<br />
                <em className="not-italic text-[#e03030]">{t.home.mainH2}</em><br />
                {t.home.mainH3}
              </h2>
              <a
                href="https://wa.me/6287818310416"
        ...
        <div className="w-full -mt-4" style={{ height: '460px' }}>
          <CircularGallery
            items={[
              { image: '/JERSEY CUSTOMER/Mar28-02_01.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar28-02_02.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar28-02_05.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar28-02_06.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar30-01_01.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar30-01_02.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar30-01_04.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar30-01_05.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar30-01_07.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Mar30-01_08.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr01-02_01.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr01-02_02.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr-01-03_02.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr-01-03_03.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr04-02_03.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr04-02_06.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr08-01_01.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr08-01_02.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr08-01_03.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr10-01_02.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr10-01_04.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr10-01_05.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr11-01_02.jpg', text: '' },
              { image: '/JERSEY CUSTOMER/Apr11-01_03.jpg', text: '' },
            ]}
            bend={2}
            textColor="#ffffff"
            borderRadius={0.05}
      ...
      <section className="relative overflow-hidden mt-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center">
          ...
          {/* Kanan: kategori */}
          <div>
            <h3 className="text-white font-black text-2xl leading-snug mb-6 whitespace-pre-line">
              {t.home.categoryHeading}
            </h3>
            <ul className="grid grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {t.home.categories.map((k) => (
            ...
            <p className="text-[#e03030] text-xs font-bold tracking-[0.2em] uppercase">{t.home.hashtag}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 border-t border-[#1a1a1a]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mb-14 text-center">
            <p className="text-[#e03030] text-[10px] font-bold uppercase tracking-[0.35em] mb-3">{t.home.testimonialLabel}</p>
            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight mb-4">{t.home.testimonialH2}</h2>
