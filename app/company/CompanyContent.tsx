    ...
    <div className="text-white">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="text-[#e03030] text-[10px] font-bold uppercase tracking-[0.3em]">{c.label}</p>
              </div>
              <h1 className="text-6xl font-black uppercase leading-[0.88] tracking-tight whitespace-pre-line">
                {c.heroH1}
              </h1>
            </div>
            ...
            <div className="border-l-2 border-[#e03030]/30 pl-5">
              <p className="text-[#777] text-sm leading-relaxed whitespace-pre-line">
                {c.heroDesc}
              </p>
            </div>
      ...
      <section className="border-b border-[#1a1a1a]">
        <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center">
          ...
          {/* Kiri — teks */}
          <div>
            <p className="text-[#e03030] text-[10px] font-bold uppercase tracking-[0.25em] mb-4">{c.whoWeAreLabel}</p>
            <h2 className="text-3xl md:text-4xl font-black uppercase leading-tight mb-8 whitespace-pre-line">
              {c.whoWeAreH2}
            </h2>
      ...
      <section className="border-b border-[#1a1a1a] py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-16">
            <div>
              <p className="text-[#e03030] text-[10px] font-bold uppercase tracking-[0.3em] mb-4">{c.valuesLabel}</p>
      ...
      <section className="border-b border-[#1a1a1a]">
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="mb-14">
            <p className="text-[#e03030] text-[10px] font-bold uppercase tracking-[0.25em] mb-3">{c.founderLabel}</p>
            <h2 className="text-3xl font-black uppercase">{c.founderH2}</h2>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center md:items-start max-w-2xl">
            ...
            <div className="group relative shrink-0 w-56 overflow-hidden border border-[#1a1a1a] hover:border-[#e03030]/30 transition-all duration-300">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-4 py-3">
                <p className="text-[#e03030] text-[9px] font-bold uppercase tracking-[0.2em]">{c.ceoBadge}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div>
                <h3 className="text-white text-2xl font-black uppercase leading-tight mb-1 whitespace-pre-line">
                  {c.founderName}
                </h3>
                <p className="text-[#555] text-xs uppercase tracking-[0.2em]">{c.founderRole}</p>
              </div>
